...
public class DVDPlayerXMLConfigTest {
	...
	@Autowired
	@Qualifier("anvengersInfinityWar")
	private DigitalVideoDisc dvd3;
	
	@Autowired
	@Qualifier("anvengersEndgame")
	private DigitalVideoDisc dvd4;
	
	@Autowired
	@Qualifier("anvengersAgeOfUltron")
	...
	public void testDVD4(){
		...
		assertEquals("BlankDisc [title=Avengers End Game, studio=MARVEL, actors=null]", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
	}
	...
	public void testDVD5(){
		...
		assertEquals("BlankDisc [title=Anvengers Age Of Ultron, studio=MARVEL, actors=null]", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
	}
	@Test
	...
	public void testDVD7(){
		...
		assertEquals("BlankDisc [title=Avengers Director's Edition, studio=MARVEL, actors=[Robert, Sacalet, Chris]]", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
	}
	@Test
	public void testDVD8(){
		assertNotNull(dvd8);
		System.out.println(dvd8);
		assertEquals("BlankDisc [title=Avengers Expansion Pack1, studio=MARVEL, actors=[Robert, Scarlett, Chris]]", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
	}
	@Test
	public void testDVD9(){
		assertNotNull(dvd9);
		System.out.println(dvd9);
		assertEquals("BlankDisc [title=Avengers Expansion Pack2, studio=MARVEL, actors=[Robert, Scarlett, Chris]]", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
	}
	...
	public void testDVD10(){
		...
		assertEquals("BlankDisc [title=Avengers Expansion Pack3, studio=MARVEL, actors=[Robert, Scarlett, Chris]]", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
	}
	...
	public void testPlay3() {
		player3.play();
		assertEquals("Playing Movie IRONMAN's Avengers", systemOutRule.getLog().replace("\r\n", "\n").replaceAll("\n", ""));
